...
namespace Elsa.Catalog.Persistence.EntityFrameworkCore.Migrations;

[DbContext(typeof(CatalogDbContext))]
[Migration("20260514000000_InitialCatalogCreate")]
public partial class InitialCatalogCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_ApprovalRecords", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_PackageSources", x => x.Id));
        ...
        migrationBuilder.CreateIndex("IX_Features_PackageVersionId_FeatureId", "Features", new[] { "PackageVersionId", "FeatureId" }, unique: true);
        migrationBuilder.CreateIndex("IX_FeatureSettings_FeatureRecordId_Name", "FeatureSettings", new[] { "FeatureRecordId", "Name" }, unique: true);
        migrationBuilder.CreateIndex("IX_ManifestValidationResults_PackageVersionId", "ManifestValidationResults", "PackageVersionId");
        migrationBuilder.CreateIndex("IX_Packages_SourceId_PackageId", "Packages", new[] { "SourceId", "PackageId" }, unique: true);
        migrationBuilder.CreateIndex("IX_PackageVersions_PackageId_Version", "PackageVersions", new[] { "PackageId", "Version" }, unique: true);
        migrationBuilder.CreateIndex("IX_SyncRunItems_PackageVersionId", "SyncRunItems", "PackageVersionId");
        migrationBuilder.CreateIndex("IX_SyncRunItems_SyncRunId", "SyncRunItems", "SyncRunId");
    }
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropTable(name: "ManifestValidationResults");
        migrationBuilder.DropTable(name: "SyncRunItems");
        ...
        migrationBuilder.DropTable(name: "PackageSources");
    }
}
