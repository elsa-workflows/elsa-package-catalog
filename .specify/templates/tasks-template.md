...
- [ ] T010 Verify package processing never loads or executes indexed package assemblies
- [ ] T011 Add persisted diagnostics for sync runs, validation errors, indexing decisions, and suspicious changes
- [ ] T012 Verify public APIs hide invalid, unapproved, rejected, suspicious, and unlisted package versions
...
- [ ] TXXX Validate manifest schema versioning and extension metadata behavior
- [ ] TXXX Review new abstractions and dependencies against constitution simplicity rules
- [ ] TXXX Confirm operational debugging data is visible through admin workflows
